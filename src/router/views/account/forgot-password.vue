              ...
              <router-link to="/">
                <div class="avatar-md profile-user-wid mb-4">
                  <span class="avatar-title rounded-circle bg-light">
                    <img src="@/assets/images/Logo-SYV-Management-03.svg" alt height="34" />
                  </span>
                </div>
              </router-link>
            </div>
            ...
            <div class="p-2">
              ...
              <form @submit.prevent="tryToReset">
                <div class="mb-3">
                  ...
                  >
                    <span v-if="!$v.email.required">El correo electrónico es obligatorio.</span>
                    <span v-if="!$v.email.email"
                      >Por favor, introduzca una dirección de correo electrónico válida.</span
                    >
                  </div>
                </div>
